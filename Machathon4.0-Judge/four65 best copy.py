...
def run_car(simulator: Simulator) -> None:
    ...
    #    throttle = 3.45
    #else:
    #    new_steering*=1.2*(1.4-0.8*abs(slope))
    #elif throttle<4.3:
    #    throttle = 4.5
    #    sign = np.sign(new_steering)
    #    new_steering=sign*math.pi*0.5/6.5
    #throttle=2
    ...
    #new_steering=stabilize_steering_angle(last_steering_angle, steering, number_lanes,10,5)
    #out_img = display_heading_line(out_img,0.5*np.pi-new_steering,line_color=(0,255,255))
