...
class Judge:
    ...
    def run_unsafe(self, send_score: bool = True, verbose: bool = True) -> None:
        ...
        print("Time taken to finish the first track: ",lap_time1)

        # execute the competitor's code on the track's opposite direction
        lap_time2 = self.run_track(self.simulator)
        print("Time taken to finish the second track: ",lap_time2)
        ...
        if verbose:
            ...
            print("Your score is: ", forward_laptime + backward_laptime)
